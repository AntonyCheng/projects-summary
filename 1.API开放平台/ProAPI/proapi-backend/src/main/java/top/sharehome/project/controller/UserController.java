...
import top.sharehome.project.model.dto.user.*;
import top.sharehome.project.model.vo.UserVO;
...
public class UserController {
     ...
     */
    @PostMapping("/login")
    @RequestMapping(value = "/login", method = {RequestMethod.POST, RequestMethod.DELETE})
